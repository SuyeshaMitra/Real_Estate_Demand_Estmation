...
========================================
Target Combination: (Latitude and Longitude) + OSM + Rates World Bank
...
print("Executing Phase 08: 08G_LatLon_OSM_Rates")
...
features = ['latitude', 'longitude', 'distance_to_nearest_hospital_km', 'distance_to_nearest_bank_km', 'distance_to_nearest_school_km', 'distance_to_nearest_station_km', 'boe_interest_rate']
