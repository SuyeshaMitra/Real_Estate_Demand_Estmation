...
========================================
Target Combination: Google News + Google Trends + Rates World Bank
...
print("Executing Phase 08: 08V_News_Trends_Rates")
...
features = ['sbert_sentiment_index', 'google_trends_volume', 'boe_interest_rate']
