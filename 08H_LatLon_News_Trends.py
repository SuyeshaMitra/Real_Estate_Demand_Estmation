...
========================================
Target Combination: (Latitude and Longitude) + Google News + Google Trends
...
print("Executing Phase 08: 08H_LatLon_News_Trends")
...
features = ['latitude', 'longitude', 'sbert_sentiment_index', 'google_trends_volume']
