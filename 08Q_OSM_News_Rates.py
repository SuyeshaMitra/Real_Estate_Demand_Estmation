...
========================================
Target Combination: OSM + Google News + Rates World Bank
...
print("Executing Phase 08: 08Q_OSM_News_Rates")
...
features = ['distance_to_nearest_hospital_km', 'distance_to_nearest_bank_km', 'distance_to_nearest_school_km', 'distance_to_nearest_station_km', 'sbert_sentiment_index', 'boe_interest_rate']
