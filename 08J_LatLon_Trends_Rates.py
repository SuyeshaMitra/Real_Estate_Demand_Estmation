...
========================================
Target Combination: (Latitude and Longitude) + Google Trends + Rates World Bank
...
print("Executing Phase 08: 08J_LatLon_Trends_Rates")
...
features = ['latitude', 'longitude', 'google_trends_volume', 'boe_interest_rate']
