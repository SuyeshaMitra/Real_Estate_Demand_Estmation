...
========================================
Target Combination: (Latitude and Longitude) + OSM + Google News + Rates World Bank
...
print("Executing Phase 08: 08B_LatLon_OSM_News_Rates")
...
features = ['latitude', 'longitude', 'distance_to_nearest_hospital_km', 'distance_to_nearest_bank_km', 'distance_to_nearest_school_km', 'distance_to_nearest_station_km', 'sbert_sentiment_index', 'boe_interest_rate']
