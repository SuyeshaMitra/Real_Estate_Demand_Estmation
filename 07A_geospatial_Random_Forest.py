...
print("======================================================")
print(" 07A: EXECUTING RANDOM FOREST ON ENRICHED DATASET")
print("======================================================")
...
# 4. Train Model
print("4. Training Random Forest Regressor (Depth=20, Estimators=50)...")
...
postcode_metrics.to_csv("07A_RandomForest_Postcode_Errors.csv", index=False)
...
plt.plot(forecast_yearly['year'], forecast_yearly['predicted_price'], label='Random Forest Forecast (2018-2022)', color='red', marker='X', linestyle='--', linewidth=3)
plt.title('Random Forest: Actual vs Forecasted Real Estate Prices (London)', fontsize=16)
...
plt.title('Random Forest: Median Accuracy % by Month & Year', fontsize=16)
plt.ylabel('Month', fontsize=12)
plt.xlabel('Year', fontsize=12)
plt.savefig('07A_Yearly_Monthly_Error_Heatmap.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.scatter(top_postcodes['Avg_Price'], top_postcodes['MAE'], alpha=0.6, color='red')
plt.title('Random Forest: MAE Distribution across London Postcodes', fontsize=16)
plt.xlabel('Average Postcode Property Price (£)', fontsize=12)
plt.ylabel('Mean Absolute Error (£)', fontsize=12)
plt.grid(True, alpha=0.3)
plt.savefig('07A_Postal_Code_Error_Distribution.png', dpi=300, bbox_inches='tight')
plt.close()

print(" -> [SAVED] 07A_Historical_vs_Forecast_Prices.png")
print(" -> [SAVED] 07A_Yearly_Monthly_Error_Heatmap.png")
print(" -> [SAVED] 07A_Postal_Code_Error_Distribution.png")

print("\n======================================================")
print(" RANDOM FOREST VALIDATION COMPLETELY EXECUTED!")
print("======================================================")
