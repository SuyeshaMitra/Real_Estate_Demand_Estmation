...
print("Executing Phase 08: 08Z_OSM_Only")
...
features = ['distance_to_nearest_hospital_km', 'distance_to_nearest_bank_km', 'distance_to_nearest_school_km', 'distance_to_nearest_station_km']
