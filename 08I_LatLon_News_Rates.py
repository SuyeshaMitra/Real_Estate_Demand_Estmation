...
========================================
Target Combination: (Latitude and Longitude) + Google News + Rates World Bank
...
print("Executing Phase 08: 08I_LatLon_News_Rates")
...
features = ['latitude', 'longitude', 'sbert_sentiment_index', 'boe_interest_rate']
