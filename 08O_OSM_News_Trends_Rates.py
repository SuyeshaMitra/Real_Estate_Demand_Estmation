...
========================================
Target Combination: OSM + Google News + Google Trends + Rates World Bank
...
print("Executing Phase 08: 08O_OSM_News_Trends_Rates")
...
features = ['distance_to_nearest_hospital_km', 'distance_to_nearest_bank_km', 'distance_to_nearest_school_km', 'distance_to_nearest_station_km', 'sbert_sentiment_index', 'google_trends_volume', 'boe_interest_rate']
