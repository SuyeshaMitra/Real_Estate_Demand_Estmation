...
print("======================================================")
print(" 07E: EXECUTING ABLATION (ALL FEATURES COMBINED)")
print("======================================================")
...
plt.title('07E All Features Combined: Actual vs Forecasted Prices', fontsize=16)
plt.xlabel('Year', fontsize=12)
plt.ylabel('Average Price (£)', fontsize=12)
plt.grid(True, alpha=0.3)
plt.legend(fontsize=12)
plt.savefig('07E_Historical_vs_Forecast_Prices.png', dpi=300, bbox_inches='tight')
plt.close()

# Save predictions for the unified comparison script
test_df_copy[['year', 'month', 'price', 'LightGBM_pred', 'LightGBM_error', 'LightGBM_acc']].to_csv('07E_Combined_LightGBM_Predictions.csv', index=False)

print("\n-> [SAVED] 07E_Historical_vs_Forecast_Prices.png")
print("-> [SAVED] 07E_Combined_LightGBM_Predictions.csv")
print("======================================================")
