...
========================================
Target Combination: OSM + Google Trends + Rates World Bank
...
print("Executing Phase 08: 08R_OSM_Trends_Rates")
...
features = ['distance_to_nearest_hospital_km', 'distance_to_nearest_bank_km', 'distance_to_nearest_school_km', 'distance_to_nearest_station_km', 'google_trends_volume', 'boe_interest_rate']
