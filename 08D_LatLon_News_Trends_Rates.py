...
========================================
Target Combination: (Latitude and Longitude) + Google News + Google Trends + Rates World Bank
...
print("Executing Phase 08: 08D_LatLon_News_Trends_Rates")
...
features = ['latitude', 'longitude', 'sbert_sentiment_index', 'google_trends_volume', 'boe_interest_rate']
