...
========================================
Target Combination: (Latitude and Longitude) + OSM + Google Trends
...
print("Executing Phase 08: 08F_LatLon_OSM_Trends")
...
features = ['latitude', 'longitude', 'distance_to_nearest_hospital_km', 'distance_to_nearest_bank_km', 'distance_to_nearest_school_km', 'distance_to_nearest_station_km', 'google_trends_volume']
