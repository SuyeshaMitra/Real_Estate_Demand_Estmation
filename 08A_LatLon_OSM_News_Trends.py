...
========================================
Target Combination: (Latitude and Longitude) + OSM + Google News + Google Trends
...
print("Executing Phase 08: 08A_LatLon_OSM_News_Trends")
...
features = ['latitude', 'longitude', 'distance_to_nearest_hospital_km', 'distance_to_nearest_bank_km', 'distance_to_nearest_school_km', 'distance_to_nearest_station_km', 'sbert_sentiment_index', 'google_trends_volume']
