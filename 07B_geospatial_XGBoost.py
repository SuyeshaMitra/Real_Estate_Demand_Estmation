...
print("======================================================")
print(" 07B: EXECUTING XGBOOST ON ENRICHED DATASET")
print("======================================================")
...
# 4. Train Model
print("4. Training XGBoost Regressor (Depth=10, Estimators=100)...")
...
postcode_metrics.to_csv("07B_XGBoost_Postcode_Errors.csv", index=False)
...
plt.plot(forecast_yearly['year'], forecast_yearly['predicted_price'], label='XGBoost Forecast (2018-2022)', color='green', marker='X', linestyle='--', linewidth=3)
plt.title('XGBoost: Actual vs Forecasted Real Estate Prices (London)', fontsize=16)
plt.xlabel('Year', fontsize=12)
plt.ylabel('Average Price (£)', fontsize=12)
plt.grid(True, alpha=0.3)
plt.legend(fontsize=12)
plt.savefig('07B_Historical_vs_Forecast_Prices.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.title('XGBoost: Median Accuracy % by Month & Year', fontsize=16)
plt.ylabel('Month', fontsize=12)
plt.xlabel('Year', fontsize=12)
plt.savefig('07B_Yearly_Monthly_Error_Heatmap.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.scatter(top_postcodes['Avg_Price'], top_postcodes['MAE'], alpha=0.6, color='green')
plt.title('XGBoost: MAE Distribution across London Postcodes', fontsize=16)
plt.xlabel('Average Postcode Property Price (£)', fontsize=12)
plt.ylabel('Mean Absolute Error (£)', fontsize=12)
plt.grid(True, alpha=0.3)
plt.savefig('07B_Postal_Code_Error_Distribution.png', dpi=300, bbox_inches='tight')
plt.close()

print(" -> [SAVED] 07B_Historical_vs_Forecast_Prices.png")
print(" -> [SAVED] 07B_Yearly_Monthly_Error_Heatmap.png")
print(" -> [SAVED] 07B_Postal_Code_Error_Distribution.png")

print("\n======================================================")
print(" XGBOOST VALIDATION COMPLETELY EXECUTED!")
print("======================================================")
